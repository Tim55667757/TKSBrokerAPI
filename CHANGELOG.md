...
* [В работе] [#7](https://github.com/Tim55667757/TKSBrokerAPI/issues/7) Добавлена возможность поиска инструмента по части названия, тикера или FIGI. Добавлен ключ `--search`.
