...
**ВНИМАНИЕ! ВАЖНО! Временно используйте версию [1.6.dev155](https://pypi.org/project/tksbrokerapi/1.6.dev155/) или любые другие более старшие фича-сборки из develop-ветки.** К сожалению, в ранних версиях уже изменился rest и они стали нерабочие.
