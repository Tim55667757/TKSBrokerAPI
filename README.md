...
- [Пример скрипта на Python: как использовать фильтр Хампеля для фильтрации аномалий во временных рядах](https://github.com/Tim55667757/TKSBrokerAPI/tree/develop/docs/examples/TestAnomalyFilter.py)
