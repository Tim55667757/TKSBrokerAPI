...
class TestTKSBrokerAPIMethods:
    ...
    def test_SearchByTickerPositive(self):
        testData = [  # tickers and their corresponding instruments:
            ...
            ("YNDX", {'figi': 'BBG006L8G4H1', 'ticker': 'YNDX', 'classCode': 'TQBR', 'isin': 'NL0009805522', 'lot': 1, 'currency': 'rub', 'klong': {'units': '2', 'nano': 0}, 'kshort': {'units': '2', 'nano': 0}, 'dlong': {'units': '0', 'nano': 366600000}, 'dshort': {'units': '0', 'nano': 457300000}, 'dlongMin': {'units': '0', 'nano': 204100000}, 'dshortMin': {'units': '0', 'nano': 207200000}, 'shortEnabledFlag': True, 'name': 'Yandex', 'exchange': 'MOEX_WEEKEND', 'ipoDate': '2011-05-24T00:00:00Z', 'issueSize': '323800479', 'countryOfRisk': 'RU', 'countryOfRiskName': 'Российская Федерация', 'sector': 'telecom', 'issueSizePlan': '0', 'nominal': {'currency': 'eur', 'units': '0', 'nano': 10000000}, 'tradingStatus': 'SECURITY_TRADING_STATUS_NORMAL_TRADING', 'otcFlag': False, 'buyAvailableFlag': True, 'sellAvailableFlag': True, 'divYieldFlag': False, 'shareType': 'SHARE_TYPE_COMMON', 'minPriceIncrement': {'units': '0', 'nano': 200000000}, 'apiTradeAvailableFlag': True, 'uid': '10e17a87-3bce-4a1f-9dfc-720396f98a3c', 'realExchange': 'REAL_EXCHANGE_MOEX', 'positionUid': 'cb51e157-1f73-4c62-baac-93f11755056a', 'forIisFlag': True, 'first1minCandleDate': '2018-03-07T18:38:00Z', 'first1dayCandleDate': '2014-06-04T07:00:00Z', 'type': 'Shares', 'step': 0.2}),
            ...
            ("TGLD", {'figi': 'BBG222222222', 'ticker': 'TGLD', 'classCode': 'TQTD', 'isin': 'RU000A101X50', 'lot': 100, 'currency': 'usd', 'shortEnabledFlag': False, 'name': 'Тинькофф Золото', 'exchange': 'MOEX', 'fixedCommission': {'units': '0', 'nano': 450000000}, 'focusType': 'equity', 'releasedDate': '2020-07-13T00:00:00Z', 'countryOfRisk': '', 'countryOfRiskName': '', 'sector': '', 'rebalancingFreq': '', 'tradingStatus': 'SECURITY_TRADING_STATUS_NORMAL_TRADING', 'otcFlag': False, 'buyAvailableFlag': True, 'sellAvailableFlag': True, 'minPriceIncrement': {'units': '0', 'nano': 100000}, 'apiTradeAvailableFlag': True, 'uid': 'a4b3adc6-4e04-4f06-9048-431aa1ed07ac', 'realExchange': 'REAL_EXCHANGE_MOEX', 'positionUid': '548bde28-a5ea-4b7b-83d3-47b4c56a0167', 'forIisFlag': True, 'first1minCandleDate': '2020-08-26T07:00:00Z', 'first1dayCandleDate': '2020-08-26T07:00:00Z', 'type': 'Etfs', 'step': 0.0001}),
        ]
