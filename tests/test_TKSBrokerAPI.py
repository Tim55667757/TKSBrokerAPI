...
class TestTKSBrokerAPIMethods:
    ...
    def test_ShowInstrumentsInfoPositive(self):
        ...
        result[2] = "* **Actual on date:** [2022-09-04 13:38] (UTC)"  # replace 3 string with date similar as in InstrumentsInfoDump.md
