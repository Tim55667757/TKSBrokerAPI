...
* 🇺🇸 [See current changelog in english here (актуальный ченджлог на английском)](https://github.com/Tim55667757/TKSBrokerAPI/blob/master/CHANGELOG.md)
* 💡 [Все запланированные к выпуску релизы и вошедшие в них фичи](https://github.com/Tim55667757/TKSBrokerAPI/milestones?direction=desc&sort=title&state=open)
...
* 🎁 Поддержать проект донатом на yoomoney-кошелёк: [410015019068268](https://yoomoney.ru/to/410015019068268)
...
* Реализованы методы открытия ордеров: `OpenOrder()`, `BuyLimit()`, `BuyStop()`, `SellLimit()` и `SellStop()`.
...
* получать список инструментов, их названия, тикеры и FIGI;
