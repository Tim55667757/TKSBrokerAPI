...
Python API для работы с [Tinkoff Open API](https://tinkoff.github.io/investAPI/swagger-ui/) и доступа к серверу брокера используя REST протокол.

***Важно!** Идёт подготовка к выпуску [release-1.1](https://github.com/Tim55667757/TKSBrokerAPI/milestone/1). Скоро тут появится документация и примеры, как работать с модулем в консоли или через import.*
...
* 📚 [Documentation and examples in english here (документация на английском)](https://tim55667757.github.io/TKSBrokerAPI)
  * 🇺🇸 [See release notes in english here (релиз-ноты на английском)](https://github.com/Tim55667757/TKSBrokerAPI/blob/master/CHANGELOG.md)
  * 🇷🇺 [Релиз-ноты](https://github.com/Tim55667757/TKSBrokerAPI/blob/master/CHANGELOG_RU.md)
